locals {
  ...
  env_content     = <<-EOF
    ...
    FRONTEND_IMAGE='ghcr.io/julieawolff/cv-workshop/frontend:fdcfc993549ad57376e33fc75e428b476bb9700f'
    BACKEND_IMAGE='ghcr.io/julieawolff/cv-workshop/backend:fdcfc993549ad57376e33fc75e428b476bb9700f'
  EOF
}
